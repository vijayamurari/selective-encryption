...
def blue_permutation1(x,y,blue_ch,blue_tr,keycol1):
               ...
               for g in keycol1:
                   ...
                   #print("Col:",col_data)f
                   row_data=rc_image3[ac,0:80]
                   transpose_image3[0:80,g]=row_data
               ...
               for j in keycol1:
                   ...
                   #print("Col:",col_data)f
                   row_data=rc_image6[af,0:80]
                   transpose_image6[0:80,j]=row_data
...
def blue_permutation2(x,y,blue_ch,blue_tr,keycol1):
               ...
               for f in keycol1:
                   ...
                   #transpose_image5[f,:80]=col_data
                   ae=ae-1
...
def blue_permutation15(x,y,blue_ch,blue_tr,keycol1):
               ...
               for z in keycol1:
                   ...
                   #print("Col:",col_data)f
                   row_data=rc_image5[ae,0:80]
                   transpose_image5[0:80,z]=row_data
                   #transpose_image5[ae,:80]=col_data
                   ae=ae-1
...
dec_start=0
dec_end=0'''
pathIn1="G:/impl/linux_backup/dec_rc_keypos_rgb_frames_l3/"
...
for i in range(len(files1)):
    ...
    print("Frame No:\n",frame_no)
    cv2.imwrite("G:/impl/linux_backup/dec_rc_keypos_rgb_frames_l2/frame%d.png" %frame_no,img)
    print("End")
